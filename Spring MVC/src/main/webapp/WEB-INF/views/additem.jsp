...
<script type="text/javascript">
	...
	<form method="post" action="insertitem.html"
		onsubmit="return formvalid()" enctype="multipart/form-data" commandName="Item">
		<div class="row mb-3">
			<div class="col">
			...
			<div class="col">
				<input type="text" name="costprice" id="costprice"
					...
					aria-label="Cost price" required>
			</div>
		...
		<div class="row">
			...
			<div class="col-2">
				<input type="text" name="stockunit" id="stockunit"
					onblur="pricevalid()" class="form-control" placeholder="Stock Unit"
					aria-label="Stock Unit" required>
			</div>
